...
int ledPin = 13;
int heatTime = 200; //80 is default from page 23 of datasheet. Controls speed of printing and darkness
int heatInterval = 200; //2 is default from page 23 of datasheet. Controls speed of printing and darkness
...
void setup() 
{
 ...
 Serial.begin(38400); // for debug info to serial monitor
  ...
  while(1) {
    ...
    else if (option == '2') 
    {
      ...
      if(printOnBlack == FALSE) {
        ...
        Thermal.print(0); //Prints text on white background
      }
    }
    else if(option == '6') {
     ...
     unsigned char x=0;
      ...
      Thermal.write('W'); //Data, cap letters, $, ., % acceptable
      Thermal.write('W');
      Thermal.write('W');
      Thermal.write('.');
      Thermal.write('S');
